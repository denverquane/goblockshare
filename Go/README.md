Running this backend service requires a [Go installation](https://golang.org/doc/install), and a correct configuration of GOROOT and GOPATH environment variables.
